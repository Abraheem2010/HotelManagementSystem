"""Unit tests for the GuestManager singleton and its CRUD operations."""
...
class TestGuestManager(unittest.TestCase):
    def setUp(self):
        ...
        self.gm.guests = []  # reset singleton state
    ...
    def test_singleton(self):
        self.assertIs(self.gm, GuestManager())
    ...
    def test_replace_guest_success(self):
        ...
        self.assertTrue(self.gm.replace_guest(5, VIPGuest(5, "New", "123")))
        self.assertIsInstance(self.gm.get_guest_by_id(5), VIPGuest)

    # ---------------- remove_guest ----------------- #
    def test_remove_guest(self):
        self.gm.load_guests(self._sample_data())
        self.assertTrue(self.gm.remove_guest(1))
